...
public class Rooms {
    ...
    public Rooms() {
        ...
        roomsMap.put(3, new Room(3, new int[]{1, 1, 1, 1}, new int[] {6, 5, 4, 1}, "Inner hallway", false, -1, false, -1));
        roomsMap.put(4, new Room(4, new int[]{1, 0, 0, 0}, new int[] {3, -1, -1, -1}, "Jeff's bathroom", false, -1, false, -1));
        roomsMap.put(5, new Room(5, new int[]{0, 0, 0, 1}, new int[] {-1, -1, -1, 3}, "Jeff's bedroom", false, -1, true, 2));

        roomsMap.put(6, new Room(6, new int[]{1, 1, 1, 1}, new int[] {8, 7, 3, 9}, "Outer hallway", false, -1, false, -1));
