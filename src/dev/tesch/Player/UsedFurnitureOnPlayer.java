...
public class UsedFurnitureOnPlayer {
    ...
    public static void useFurniture(Player player, Furniture furniture, Map<Integer, Room> userRooms, Map<Integer, Item> userItems, Map<Integer, NPC> userNPCs) {
        switch (furniture.getName()) {
            ...
            case "Crafting Table":
                useCraftingTable(player, userItems);
                break;
    ...
    private static void useCraftingTable(Player player, Map<Integer, Item> userItems) {
