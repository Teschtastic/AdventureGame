...
public class FurnitureActions {
    ...
    public static void useFurniture(Player player, Map<Integer, Room> userRooms, Map<Integer, NPC> userNPCs, Map<Integer, Item> userItems, Map<Integer, Armor> userArmors, Map<Integer, Furniture> userFurnitures) {
        ...
        if (room.isHasFurniture()) {
            if (furniture.isCanUse()) {
                ...
                UsedFurnitureOnPlayer.useFurniture(player, furniture, userRooms, userItems, userArmors, userNPCs);
            } else
